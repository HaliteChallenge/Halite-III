...
PACKAGES="build-essential gcc g++ python3 python3-pip git ocaml ocamlbuild openjdk-8-jdk php ruby scala nodejs mono-complete dotnet-sdk-2.1 libgeos-dev tcl8.5 mit-scheme racket octave luajit lua5.2 ghc esl-erlang coffeescript dart fp-compiler sbcl dmd-compiler mono-vbnc gnat-6 cmake python3-dev python-numpy cython clang libicu-dev elixir sbt libboost-python-dev libboost-all-dev"
