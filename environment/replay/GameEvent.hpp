...
class SpawnEvent : public BaseEvent {
    ...
    id_type owner_id;       /**< Id of player spawning entity */
...
public:
     ...
     */
    SpawnEvent(Location location, energy_type energy, id_type owner_id) :
...
class DeathEvent : public BaseEvent {
    ...
    id_type owner_id;   /**< Owner of dying entity */
...
public:
     ...
     */
    DeathEvent(Location location, id_type owner_id) : location(std::move(location)), owner_id(owner_id) {};
