      ...
      <div class="doc-section doc-section-play text-center">
        ...
        <div class="col-sm-6">
          <!--<div class="doc-section doc-section-play text-center"> -->
            ...
            <p>To submit your local Halite bot in the competition, upload a .zip file here. In general, the root of your zip should contain a <i>MyBot.{extension}</i> file and the <i>hlt</i> folder from the starter kit, which is sufficient for Python and Java. Some other languages will require additional files, such as <i>CMakeLists.txt</i> for C++ and <i>Cargo.toml</i> for Rust. A single top level directory in the archive that contains all the be above is supported as well.</p>
            <br>
            <halite-upload-zone
